...
public class CourseController {
    ...
    public ResponseEntity<?> uploadCourseImage(@PathVariable Long id,
        ...
        try {
            ...
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error uploading course image: " + e.getMessage()));
        }
    }
    ...
    // 5.1. Lấy curriculum công khai (chỉ tên chapters và lessons, không có nội dung
    // chi tiết)
    ...
    public ResponseEntity<Page<CourseResponse>> getAllCourses(
        ...
        Page<CourseResponse> courses = courseService.getAllPublishedCourses(keyword, categoryId, minPrice, maxPrice,
                isFree, isPaid, level, minRating, page, size, sanitizedSort);
    ...
    // 9. Giảng viên tự publish khóa học
    ...
    // 10. Giảng viên gỡ khóa học - PUBLISHED -> DRAFT
