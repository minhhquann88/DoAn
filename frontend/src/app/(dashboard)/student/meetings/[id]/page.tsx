...
import { getMeeting, joinMeeting, leaveMeeting, type Meeting } from '@/services/meetingService';
...
export default function StudentMeetingDetailPage() {
  ...
  const leaveMutation = useMutation({
    ...
    onSuccess: () => {
      setHasJoined(false);
      router.push(ROUTES.STUDENT.MEETINGS);
    },
    onError: (error: any) => {
      addToast({
        type: 'error',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => router.push(ROUTES.STUDENT.MEETINGS)}>
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button
              variant="ghost"
              size="sm"
              onClick={() => router.push(ROUTES.STUDENT.MEETINGS)}
            >
              <ArrowLeft className="h-4 w-4 mr-2" />
              Quay lại
            </Button>
