...
export function ChatWindow({
  ...
  // Filter typing indicators to only show other participant's typing, not current user's
  const otherParticipantTyping = otherParticipant 
    ? typingUserIds.has(otherParticipant.id)
    : false;
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-background">
      ...
      {/* Typing Indicator - Only show if other participant is typing */}
